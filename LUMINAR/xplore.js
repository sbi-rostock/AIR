...
async function updateXploreSelectionStatus() {
    ...
    if (count > 0) {
        ...
        namesEl.html(`<div class="d-flex mb-2 mt-1 flex-nowrap align-items-center gap-2" style="width: max-content; min-width: 100%; white-space: nowrap;"><span style="color: #718096;">Click to select (Hold ctrl for multiple)</span>${manualEntryChip}</div>`);
