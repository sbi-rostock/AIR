                                                    ...
                                                    readServerValues().then(r => {
                                                        ...
                                                        readCentralityValues().then(r => {
                                                            ...
                                                            <div class="air_alert alert alert-info mt-2" id="air_welcome_alert">
                                                                <span>The Plugins are still under development. Future updates may change the results of analyses. For any further questions, please contact the <a href="https://air.bio.informatik.uni-rostock.de/team" target="_blank">developers</a>.</span>
