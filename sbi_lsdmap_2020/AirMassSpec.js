async function AirMassSpec(){    
    ...
    $(
        ...
        <div class="row mb-1 mt-2">
            ...
            <div class="col">
                <select id="ms_mzSelect" class="browser-default ms_select custom-select">
        ...
        <div class="row mb-1 mt-1">
            ...
            <div class="col">
                <select id="ms_retentionSelect" class="browser-default ms_select custom-select">
        ...
        <div class="row mb-1 mt-1">
            ...
            <div class="col">
                <select id="ms_ccsSelect" class="browser-default ms_select custom-select">
        ...
        <button type="button" id="ms_btn_readdata" class="air_btn btn btn-block mt-2 mb-2">Read File</button>
